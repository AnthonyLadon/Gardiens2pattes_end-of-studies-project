...
class RegistrationMaitreFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('newsLetter', CheckboxType::class, [
                'label' => $this->translator->trans('Inscription à la newsletter', [], 'form'),
                'mapped' => false,
                'required' => false
            ])
            ->add('telNum', TextType::class, [
                'label' => $this->translator->trans('Numéro de tél.', [], 'form'),
                'mapped' => false,
                'required' => false,
                'attr' => [
            ...
            ->add('numero', NumberType::class, [
                'label' => $this->translator->trans('Numero'),
                'required' => true,
                'mapped' => false,
                'attr' => [
